...
* 6 Animations: shift-up, shift-down, shift-left, shift-right, fade, flip.
* Full with layout.
* Boxed layout.
...
If you want more documentation about EasyMega you can find it [here](http://docs.famethemes.com/article/110-easymega-documentation).

== Screenshots ==

1. Mega menu settings.
2. Enable mega menu.
3. Mega menu item settings.
4. Columnize mega layout builder.
5. Content grid mega layout out settings.
6. Frontend columnize layout.
7. Frontend content grid mega layout.

== Installation ==

1. Upload the plugin files to the `/wp-content/plugins/` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Go to Customizer -> Menu to enable mega menu.
